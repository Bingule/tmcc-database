...
Four figures—b-value, selected-potential fit, Dunn current components, and contribution percentage—can each be exported as SVG or PNG. Tables and charts use horizontally scrollable wide containers and responsive one-column layouts on narrow screens.
