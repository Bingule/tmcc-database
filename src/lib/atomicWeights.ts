/**
 * CIAAW 2024 abridged standard atomic weights, using the published central
 * (abridged) values. CIAAW does not assign standard atomic weights to the
 * radioactive elements below; those use the NIST SP 966 June 2024 bracketed
 * mass numbers so every valid element can be handled.
 * Sources: https://www.ciaaw.org/abridged-atomic-weights.htm and
...
export const atomicWeights: Record<string, number> = {
  ...
  Ga: 69.723, Ge: 72.63, As: 74.922, Se: 78.971, Br: 79.904, Kr: 83.798, Rb: 85.468, Sr: 87.62, Y: 88.906, Zr: 91.222,
  ...
  No: 259, Lr: 262, Rf: 267, Db: 268, Sg: 269, Bh: 270, Hs: 269, Mt: 277, Ds: 281, Rg: 282,
